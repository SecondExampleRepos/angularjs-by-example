<!-- Converted from src/components/show/show.tpl.html -->
<div class="show-frame">
  ...
  <div class="inner">
    <ul class="info">
      ...
      <li class="col-xs-6 country"><span class="icon icon-earth"></span> <span *ngFor="let country of show.origin_country">{{country}}{{show.origin_country.indexOf(country) === show.origin_country.length - 1 ? '' : ', '}}</span> <span *ngIf="show.origin_country.length == 0">--</span></li>
