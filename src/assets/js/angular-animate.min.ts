(function(N: any, f: any, W: any) { 
'use strict'; 
f.module("ngAnimate", ["ng"]).directive("ngAnimateChildren", function() { 
return function(X: any, C: any, g: any) { 
g = g.ngAnimateChildren; 
f.isString(g) && 0 === g.length ? C.data("$$ngAnimateChildren", !0) : X.$watch(g, function(f: any) { 
C.data("$$ngAnimateChildren", !!f) 
}) 
} 
}).factory("$$animateReflow", ["$$rAF", "$document", function(f: any, C: any) { 
return function(g: any) { 
return f(function() { 
g() 
}) 
} 
}]).config(["$provide", "$animateProvider", function(X: any, C: any) { 
function g(f: any) { 
...
r = { running: !0 }, 
u; 
X.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function(O: any, N: any, M: any, Y: any, y: any, H: any, P: any, W: any, Z: any, Q: any) { 
...
function S(a: any, c: any, b: any) { 
b = b || {}; 
var d: any = {}; 
n(b, function(e: any, a: any) { 
n(a.split(" "), function(a: any) { 
d[a] = e 
}) 
}); 
var h = Object.create(null); 
n((a.attr("class") || "").split(/\s+/), function(e: any) { 
h[e] = !0 
}); 
var f: any[] = [], 
l: any[] = []; 
n(c && c.classes || [], function(e: any, a: any) { 
var b = h[a], 
c = d[a] || {}; 
...
cancel: function() { 
m && (n(m, function(a: any) { 
(a || t)(!0) 
}), ca(!0)); 
s && (n(s, function(a: any) { 
(a || t)(!0) 
}), g(!0)) 
} 
} 
...
function G(a: any, c: any, b: any, d: any, h: any, k: any, l: any, e: any) { 
function A(e: any) { 
var l = "$animate:" + e; 
...
m && m.applyStyles(); 
g.hasBeenRun = !0; 
l && l.tempClasses && n(l.tempClasses, function(a: any) { 
u.removeClass(b, a) 
}); 
...
L = d.active || {}; 
s = d.totalActive || 0; 
if ("leave" == a) b.one("$destroy", function(a: any) { 
a = f.element(this); 
...
function q(a: any) { 
if (a = g(a)) a = f.isFunction(a.getElementsByClassName) ? a.getElementsByClassName("ng-animate") : a.querySelectorAll(".ng-animate"), n(a, function(a: any) { 
a = f.element(a); 
(a = a.data("$$ngAnimateState")) && a.active && n(a.active, function(a: any) { 
a.cancel() 
}) 
}) 
} 
function B(a: any, c: any) { 
...
return { 
animate: function(a: any, c: any, b: any, d: any, h: any) { 
d = d || "ng-inline-animate"; 
h = I(h) || {}; 
h.from = b ? c : null; 
h.to = b ? b : c; 
return D(function(b: any) { 
return G("animate", d, f.element(g(a)), null, null, t, h, b) 
}) 
}, 
enter: function(a: any, c: any, b: any, d: any) { 
d = I(d); 
a = f.element(a); 
c = c && f.element(c); 
b = b && f.element(b); 
R(a, !0); 
O.enter(a, c, b); 
return D(function(h: any) { 
return G("enter", "ng-enter", f.element(g(a)), c, b, t, d, h) 
}) 
}, 
leave: function(a: any, c: any) { 
c = I(c); 
a = f.element(a); 
q(a); 
R(a,3295 !0); 
...
move: function(a: any, c: any, b: any, d: any) { 
d = I(d); 
a = f.element(a); 
c = c && f.element(c); 
b = b && f.element(b); 
...
addClass: function(a: any, c: any, b: any) { 
return this.setClass(a, c, [], b) 
}, 
removeClass: function(a: any, c: any, b: any) { 
return this.setClass(a, [], c, b) 
}, 
setClass: function(a: any, c: any, b: any, d: any) { 
d = I(d); 
a = f.element(a); 
a = f.element(g(a)); 
...
return k.promise = D(function(e: any) { 
var l = a.parent(), 
b = g(a), 
c = b.parentNode; 
...
cancel: function(a: any) { 
a.$$cancelFn() 
}, 
enabled: function(a: any, c: any) { 
...
C.register("", ["$window", "$sniffer", "$timeout", "$$animateReflow", function(r: any, C: any, M: any, Y: any) { 
function y() { 
b || (b = Y(function() { 
c = []; 
b = null; 
...
function X(a: any) { 
n(a, function(a: any) { 
(a = a.data("$$ngAnimateCSS3Data")) && n(a.closeAnimationFns, function(a: any) { 
a() 
}) 
}) 
} 
function Z(a: any, e: any) { 
var b = e ? x[e] : null; 
if (!b) { 
var c = 0, 
d = 0, 
...
function R(b: any, e: any, c: any, d: any) { 
...
function D(a: any, e: any, b: any, c: any, d: any) { 
function f() { 
e.off(D, h); 
u.removeClass(e, k); 
u.removeClass(e, t); 
...
function S(a: any, b: any, c: any, d: any) { 
if (R(a, b, c, d)) return function(a: any) { 
a && G(b, c) 
} 
} 
function T(a: any, b: any, c: any, d: any, f: any) { 
if (b.data("$$ngAnimateCSS3Data")) return D(a, b, c, d, f); 
G(b, c); 
d() 
} 
function U(a: any, b: any, c: any, d: any, f: any) { 
...
k: any[] = []; 
return { 
animate: function(a: any, b: any, c: any, d: any, f: any, g: any) { 
g = g || {}; 
g.from = c; 
g.to = d; 
return U("animate", a, b, f, g) 
}, 
enter: function(a: any, b: any, c: any) { 
c = c || {}; 
return U("enter", a, "ng-enter", b, c) 
}, 
leave: function(a: any, b: any, c: any) { 
c = c || {}; 
return U("leave", a, "ng-leave", b, c) 
}, 
move: function(a: any, b: any, c: any) { 
c = c || {}; 
return U("move", a, "ng-move", b, c) 
}, 
beforeSetClass: function(a: any, b: any, c: any, d: any, f: any) { 
f = f || {}; 
...
beforeAddClass: function(a: any, b: any, c: any, d: any) { 
d = d || {}; 
if (b = S("addClass", a, q(b, "-add"), d.from)) return H(a, c), b; 
y(); 
c() 
}, 
beforeRemoveClass: function(a: any, b: any, c: any, d: any) { 
d = d || {}; 
if (b = S("removeClass", a, q(b, "-remove"), d.from)) return H(a, c3639 ), b; 
y(); 
c() 
}, 
setClass: function(a: any, b: any, c: any, d: any, f: any) { 
f = f || {}; 
c = q(c, "-remove"); 
b = q(b, "-add"); 
return T("setClass", a, c + " " + b, d, f.to) 
}, 
addClass: function(a: any, b: any, c: any, d: any) { 
d = d || {}; 
return T("addClass", a, q(b, "-add"), c, d.to) 
}, 
removeClass: function(a: any, b: any, c: any, d: any) { 
d = d || {}; 
