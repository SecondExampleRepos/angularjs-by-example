...
// Importing SearchController with named import since it doesn't have a default export
import { SearchController as Search } from './components/controllers/SearchController';
