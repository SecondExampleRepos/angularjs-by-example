...
const HomeController: React.FC = () => {
    ...
    useEffect(() => {
        ...
        document.title = "HOME";
        // Assuming there's a way to set description, otherwise this is a placeholder
        // document.description = "Learn AngularJS using best practice real world examples.";
    ...
    return (
        <div>
            <h1>Home</h1>
            <p>Learn AngularJS using best practice real world examples.</p>
            <ul>
