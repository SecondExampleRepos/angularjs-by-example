...
const HomeController: React.FC = () => {
  const [tutorials] = useState<Tutorial[]>(tutorialsData);
    ...
    <div className="home-frame">
      <div className="home-banner">
        <div className="container inner">
          ...
          <h2>Learn how to build superb AngularJS web applications using real world best practice examples coupled with in-depth tutorials from <a href="http://www.revillweb.com">revillweb.com</a>.</h2>
          ...
          <div className="home-buttons">
            <a href="https://github.com/RevillWeb/angularjs-by-example" target="_blank" rel="noopener noreferrer" className="btn btn-lg btn-primary"><span className="icon icon-github2"></span> GitHub</a>
            <a href="http://www.revillweb.com" target="_blank" rel="noopener noreferrer" className="btn btn-lg btn-default"><span className="icon icon-home"></span> RevillWeb</a>
          </div>
        </div>
      </div>
        ...
        <ul className="tutorials">
          {tutorials.map((tutorial, index) => (
            <li key={index} className={tutorial.link === '#' ? 'offline' : ''}>
              ...
              {tutorial.link === '#' ? (
                <button className="btn btn-lg btn-primary disabled"><span className="icon icon-arrow-up-right5"></span> View</button>
              ) : (
                <a href={tutorial.link} className="btn btn-lg btn-primary"><span className="icon icon-arrow-up-right5"></span> View</a>
              )}
