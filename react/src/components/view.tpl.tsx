      ...
      <div className="view-title">
        <div className="container">
          ...
          <ul className="pull-right">
            ...
            <li><span className="icon icon-tags"></span> <span>{show.genres.map((genre, index) => `${genre.name}${index < show.genres.length - 1 ? ', ' : ''}`)}</span> </li>
      ...
      <div className="view-container">
        ...
        <div className="view-section view-top">
          ...
          <div className="buttons">
            <a href={show.homepage} target="_blank" className="btn btn-lg btn-info"><span className="icon icon-home"></span> Homepage</a>
          </div>
